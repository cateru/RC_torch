...
def train(epoch, model, train_load, loss_fn, device):
    ...
    for batch_idx, (data, target) in enumerate(train_load):
        ...
        results = model.step_manhattan_differential()
        ...
        if batch_idx % 20 == 0: 
            ...
            # logging.info(f"Readout closest indices pos: {results[0][1][:5].detach().numpy()}...")
            # logging.info(f"Readout closest indices neg: {results[0][2][:5].detach().numpy()}...")
